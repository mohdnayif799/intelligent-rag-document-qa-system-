...
```
Get your free key at aistudio.google.com → Get API Key → Create API key in new project.
Run
```bash
...
Click Process Documents. The progress bar shows reading, chunking, and embedding stages.
